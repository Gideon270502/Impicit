package com.gideon202102339.impilicitintent;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void tampilKontak(View view) {
        Intent kontakIntrent = new Intent(Intent.ACTION_MAIN);
        kontakIntrent.addCategory(Intent.CATEGORY_APP_CONTACTS);
        startActivity(kontakIntrent);
    }
